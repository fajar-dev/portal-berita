    ...
    <div class="portal-container">
        ...
        <div class="footer-grid">
            ...
            <div class="footer-brand-col">
                <a href="{{ route('news.home') }}" class="logo-main" style="color: #fff; font-size: 2rem;">
                    ...
                    @else
                        ...
                        @endphp
                        {{ strtoupper($firstPart) }}<span
                            style="color: var(--color-primary);">{{ strtoupper($secondPart) }}</span>
                    @endif
                </a>
                <p class="footer-desc">
                ...
                <div style="font-size: 0.8rem; color: hsl(220, 10%, 65%); margin-top: 15px;">
                    ...
                    Email: {{ \App\Models\Setting::get('office_email') }} | Telp:
                    {{ \App\Models\Setting::get('office_phone') }}
                </div>
            </div>
            ...
            <div class="footer-nav-col">
                ...
                <ul class="footer-links">
                    @php
                        $footerMenus = \App\Models\Menu::whereNull('parent_id')
            ...
            <div class="footer-newsletter-col">
                ...
                <p class="footer-desc" style="margin-top: 0;">
                    Dapatkan rangkuman analisis berita eksklusif dan mendalam langsung di kotak masuk email Anda setiap
                    akhir pekan.
                </p>

                <form class="newsletter-form-container">
                    <div class="newsletter-input-group">
                        <input type="email" class="newsletter-email" placeholder="Alamat email Anda..." required
        ...
        <div class="footer-bottom">
            ...
            <!-- <div class="footer-bottom-pages"
                style="display: flex; gap: 15px; font-size: 0.78rem; font-weight: 700; color: hsl(220, 10%, 60%); flex-wrap: wrap; justify-content: center;">
            ...
            <div class="social-links">
                <a href="{{ \App\Models\Setting::get('facebook_url', '#') }}" target="_blank" class="social-icon-btn"
                    aria-label="Facebook">
                ...
                <a href="{{ \App\Models\Setting::get('twitter_url', '#') }}" target="_blank" class="social-icon-btn"
                    aria-label="Twitter">
                    <svg style="width: 16px; height: 16px;" fill="currentColor" viewBox="0 0 24 24"
                        xmlns="http://www.w3.org/2000/svg">
                        <path
                ...
                <a href="{{ \App\Models\Setting::get('instagram_url', '#') }}" target="_blank" class="social-icon-btn"
