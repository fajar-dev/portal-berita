...
@section('content')
    ...
    <div style="margin-top: 25px; margin-bottom: 20px; display: flex; align-items: center; gap: 12px; flex-wrap: wrap; padding: 4px 0;">
        ...
        <div style="display: flex; gap: 8px; flex-wrap: wrap;">
            <a href="{{ route('news.search') }}?q=EBT" style="font-size: 0.78rem; font-weight: 700; background-color: var(--color-card-bg); border: 1.5px solid var(--color-border); padding: 5px 14px; border-radius: var(--border-radius-pill); color: var(--color-text);">#EnergiHijau</a>
            <a href="{{ route('news.search') }}?q=AI" style="font-size: 0.78rem; font-weight: 700; background-color: var(--color-card-bg); border: 1.5px solid var(--color-border); padding: 5px 14px; border-radius: var(--border-radius-pill); color: var(--color-text);">#KecerdasanBuatan</a>
            <a href="{{ route('news.search') }}?q=UMKM" style="font-size: 0.78rem; font-weight: 700; background-color: var(--color-card-bg); border: 1.5px solid var(--color-border); padding: 5px 14px; border-radius: var(--border-radius-pill); color: var(--color-text);">#EkonomiDigital</a>
            <a href="{{ route('news.search') }}?q=Olimpiade" style="font-size: 0.78rem; font-weight: 700; background-color: var(--color-card-bg); border: 1.5px solid var(--color-border); padding: 5px 14px; border-radius: var(--border-radius-pill); color: var(--color-text);">#SportScience</a>
            <a href="{{ route('news.search') }}?q=Badminton" style="font-size: 0.78rem; font-weight: 700; background-color: var(--color-card-bg); border: 1.5px solid var(--color-border); padding: 5px 14px; border-radius: var(--border-radius-pill); color: var(--color-text);">#BadmintonJunior</a>
        </div>
    </div>
    ...
    <div style="margin-bottom: 50px;">
        <div class="section-header">
            ...
            <span style="font-size: 0.8rem; color: var(--color-primary); font-weight: 700; text-transform: uppercase; letter-spacing: 0.5px;">Fokus Pemikiran</span>
        </div>
...
<div class="video-section">
    <div class="portal-container">
        <div class="section-header" style="border-bottom-color: rgba(255, 255, 255, 0.1);">
            ...
            <span style="font-size: 0.8rem; color: var(--color-primary); font-weight: 700; text-transform: uppercase; letter-spacing: 0.5px;">Eksklusif</span>
        </div>
...
<div class="portal-container"> <!-- Re-open container for standard layout -->
    ...
    <div style="margin-bottom: 45px;">
        <div class="section-header">
            ...
            <span style="font-size: 0.8rem; color: var(--color-primary); font-weight: 700; text-transform: uppercase; letter-spacing: 0.5px;">Jurnalisme Data</span>
        </div>
